...
shinyServer(
    function(input, output) {
        ...
        output$bulletin1014.full.dt <- renderDataTable({
            bulletin1014.dt[, list(YEAR, DISTNAME, DISTCOUNTY, AVG.FTE, RNK.FTE, LOCREV, AVG.LOCREV, RNK.LOCREV, STREV, AVG.STREV, RNK.STREV, FEDREV, AVG.FEDREV, RNK.FEDREV, TOTREV, AVG.TOTREV, RNK.TOTREV, TOTEXP, AVG.TOTEXP, RNK.TOTEXP, T.SAL, AVG.T.SAL, RNK.T.SAL, P.TCHR, AVG.P.TCHR, RNK.P.TCH)]
        })
